module Contact::Addon
  module Page
    ...
    included do
      ...
      field :contact_tel2, type: String
      field :contact_fax, type: String
      field :contact_email, type: String
      field :contact_app_dest, type: String
      ...
      permit_params :contact_tel, :contact_tel2, :contact_fax, :contact_email
      permit_params :contact_app_dest
